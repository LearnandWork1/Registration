...
const Login = () => {
  ...
  //   setLoginObj(oldobj => ({ ...oldobj, [key]: event.target.value }))
  // }
  const baseUrl = 'https://localhost:7051/'; 
  const handleLogin = async () => {
    try {     
      
      // const response = await axios.post(`${baseUrl2}api/Users/Login`, {  
      //   Email: email,
      //   Password: password,
      // });
    
      debugger;
      //alert(`${baseUrl}api/Users/Login`);
      //const response = await axios.post(`https://localhost:7053/api/Users/Login`, {                                         
